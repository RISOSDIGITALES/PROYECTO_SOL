        ...
        {onRelease && confirmingRelease && (
          <div style={costNoticeStyle}>
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 8 }}>
              <button type="button" disabled={releasing} onClick={handleRelease} className="bubble54-btn small">
                {releasing ? "Liberando…" : "Sí, liberar el número"}
              </button>
              <button type="button" className="bubble54-btn secondary small" onClick={() => setConfirmingRelease(false)}>
                Cancelar
              </button>
            </div>
          </div>
          ...
          <div className="g54-gradient" style={modalCardStyle} onClick={(e) => e.stopPropagation()}>
            ...
            {confirmingNew && (
              <>
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  <button type="button" onClick={() => handleChoose("new")} className="bubble54-btn small">
                    Sí, comprar número nuevo
                  </button>
                  <button type="button" className="bubble54-btn secondary small" onClick={closeModal}>
                    Cancelar
                  </button>
                </div>
              </>
            ...
            {forwardStep === "verify-input" && (
              ...
              <>
                ...
                />
                <button type="button" disabled={verifyBusy || !phoneInput.trim()} onClick={handleSendCode} className="bubble54-btn small" style={{ alignSelf: "start" }}>
            ...
            {forwardStep === "verify-code" && (
              <>
                ...
                />
                <div style={{ display: "flex", gap: 8 }}>
                  <button type="button" disabled={verifyBusy || !codeInput.trim()} onClick={handleCheckCode} className="bubble54-btn small">
                    {verifyBusy ? "Confirmando…" : "Confirmar código"}
                  </button>
                  <button type="button" className="bubble54-btn secondary small" onClick={() => { setError(""); setForwardStep("verify-input"); }}>
                    Volver
                  </button>
                </div>
              </>
            ...
            {forwardStep === "verify-code-done" && (
              <>
                ...
                <button type="button" onClick={handleActivateForward} className="bubble54-btn small" style={{ alignSelf: "start" }}>
...
const spinnerStyle = {
  ...
  animation: "bubble54-phone-spin 0.8s linear infinite",
};
...
if (typeof document !== "undefined" && !document.getElementById("bubble54-phone-spin-kf")) {
  const styleTag = document.createElement("style");
  styleTag.id = "bubble54-phone-spin-kf";
  styleTag.textContent = "@keyframes bubble54-phone-spin { to { transform: rotate(360deg); } }";
