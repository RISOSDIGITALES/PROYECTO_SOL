...
export default function BusinessPickerModal({ agents, onClose, onRequestCreate }) {
  return (
    <div style={overlayStyle} onClick={onClose}>
      <div className="bubble54-panel" style={modalStyle} onClick={(e) => e.stopPropagation()}>
        ...
        {agents.length > 0 ? (
          <>
            ...
            <button type="button" onClick={onClose} className="bubble54-btn" style={{ width: "100%" }}>
              Cerrar
            </button>
          </>
        ) : (
          <>
            ...
            <div style={{ display: "flex", gap: 10 }}>
              <button type="button" onClick={onClose} className="bubble54-btn secondary" style={{ flex: 1 }}>Cancelar</button>
              <button type="button" onClick={onRequestCreate} className="bubble54-btn" style={{ flex: 1 }}>
                + Crear negocio nuevo
              </button>
            </div>
          </>
