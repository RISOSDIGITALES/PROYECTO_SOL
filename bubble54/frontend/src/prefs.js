...
const KEY = "bubble54_prefs_v1";
const EVENT = "bubble54:prefs-changed";
...
// [data-bubble54-motion="off"] junto a los de la media query, no en vez de
...
function applyMotionAttr(prefs) {
  ...
  document.documentElement.setAttribute("data-bubble54-motion", prefs.animationsEnabled ? "on" : "off");
}
