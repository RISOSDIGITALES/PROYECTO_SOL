    ...
    <>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "36px 40px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 28 }}>
          ...
          <button onClick={handleCreateClick} className="bubble54-btn">+ Crear negocio</button>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 16 }}>
          {businesses.map((b) => (
            <Link key={b.id} to={`/agencia/negocios/${b.id}`} className="bubble54-card" style={cardStyle}>
