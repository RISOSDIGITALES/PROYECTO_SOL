...
export default function AgencyBusinessDetail() {
  ...
  return (
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "36px 40px" }}>
        ...
        {business && (
          <div className="bubble54-panel" style={{ padding: 24, marginTop: 12 }}>
                ...
                <div>
                  {renaming ? (
                    <form onSubmit={handleRename} style={{ display: "flex", gap: 8, alignItems: "center" }}>
                      ...
                      />
                      <button type="submit" disabled={renameSaving} className="bubble54-btn small">
                        {renameSaving ? "Guardando…" : "Guardar"}
                      </button>
                      <button type="button" onClick={cancelRenaming} className="bubble54-btn secondary small">
                        Cancelar
                      </button>
                    </form>
                  ) : (
        ...
        {business && (
          <div style={{ marginTop: 20 }}>
            ...
            <div className="bubble54-panel" style={{ padding: 20, display: "grid", gap: 12 }}>
              <Row label="Plan">
                <select
              ...
              {pendingPlanId && pendingPlanId !== business.plan_id && (
                <div style={planConfirmBoxStyle}>
                  ...
                  <div style={{ display: "flex", gap: 8 }}>
                    <button type="button" onClick={confirmPlanChange} disabled={planSaving} className="bubble54-btn small">
                      {planSaving ? "Cambiando…" : "Confirmar cambio de plan"}
                    </button>
                    <button type="button" onClick={cancelPlanChange} disabled={planSaving} className="bubble54-btn secondary small">
                      Cancelar
                    </button>
                  </div>
                </div>
