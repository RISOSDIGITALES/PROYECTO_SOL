...
export default function BusinessDashboard() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100vh" }}>
      ...
      <nav className="bubble54-sidebar g54-gradient" aria-label="Navegación de negocio">
        ...
        <div className="bubble54-sidebar-main">
          <button type="button" className="bubble54-navcol" onClick={(e) => goTo("calls", e)}>
            <span className="bubble54-navfloat" style={{ animationDelay: "-0.6s" }}>
              <span className={`bubble54-navbubble ${tab === "calls" ? "active" : ""}`}>
                ...
                {errorCallsCount > 0 && <span className="bubble54-notif">{errorCallsCount}</span>}
              </span>
            </span>
          ...
          <button type="button" className="bubble54-navcol" onClick={(e) => goTo("negocio", e)}>
            ...
            <span className="bubble54-navlabel">Negocio</span>
          </button>

          <button type="button" className="bubble54-navcol" onClick={(e) => goTo("config", e)}>
            <span className="bubble54-navfloat" style={{ animationDelay: "-1.9s" }}>
              <span className={`bubble54-navbubble hueB ${tab === "config" ? "active" : ""}`}>
          ...
          <button type="button" className="bubble54-navcol" onClick={(e) => goTo("account", e)}>
            <span className="bubble54-navfloat" style={{ animationDelay: "-3.1s" }}>
              <span className={`bubble54-navbubble hueC ${tab === "account" ? "active" : ""}`}>
                <Icon name="user" className="icon" />
              </span>
            </span>
            <span className="bubble54-navlabel">Cuenta</span>
          </button>

          <button type="button" className="bubble54-navcol" onClick={(e) => goTo("salir", e)}>
          ...
          <div style={tab === "config" ? wideWrapStyle : narrowWrapStyle}>
            ...
            {tab === "account" && (
              <div style={accountGridStyle}>
                <div className="bubble54-panel" style={accountCardStyle}>
                ...
                {me?.agency_name && (
                  <div className="bubble54-panel" style={{ ...accountCardStyle, background: "#eef4ff" }}>
                ...
                <div className="bubble54-panel" style={{ ...accountCardStyle, gridColumn: "1 / -1" }}>
