...
def test_insights_con_relay_configurado_lo_usa_en_vez_del_directo(monkeypatch):
    ...
    monkeypatch.setattr(settings, "groq_relay_url", "https://n8n.ejemplo.test/webhook/bubble54-groq-proxy")
    ...
    assert captured["url"] == "https://n8n.ejemplo.test/webhook/bubble54-groq-proxy"
