...
- [ ] **🔴 PRIORITARIO — investigar y corregir el cierre prematuro con "no gracias" en cuanto Groq se recupere** (ver ítems 101-102 del historial, 2026-07-09). Hallazgo sin confirmar: en una prueba real, el cliente dijo "no gracias" respondiendo a la recomendación de tipo de cajón, y Marco lo interpretó como que el cliente se despedía de toda la conversación, cerrando con "Quedo a tus órdenes cuando lo necesites" en vez de seguir preguntando lo que faltaba. La hipótesis de trabajo es que la conversación se clasificó como `tipo_flujo=consulta` en vez de `cotizacion` desde el principio (el cliente dijo "necesito embalar una lámpara" sin usar palabras como "cotizar"/"presupuesto"), y en modo consulta el cierre ante cualquier negativa tiene más sentido — pero **no se pudo confirmar** porque las pruebas de variación de ese día cayeron justo en la ventana donde se agotó la cuota diaria de Groq (100,000 tokens/día), contaminando los resultados. **Antes de tocar nada:** repetir 3-5 conversaciones de prueba limpias (Groq funcionando, sin caer en Modo Contingencia) variando cómo el cliente expresa que quiere embalar algo (con/sin "cotizar" explícito) y cómo responde negativamente a la recomendación de tipo de cajón, para confirmar si el problema real es (a) la clasificación tipo_flujo, (b) la regla de cierre en sí, o (c) ambas — y recién ahí decidir la corrección.
