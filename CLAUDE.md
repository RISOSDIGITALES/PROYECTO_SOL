...
**Pendiente/limitación conocida, no bloqueante:** los deals nuevos no quedan vinculados por `wa_contact_id` (solo por coincidencia de teléfono) — por eso borrar el lead de WhatsApp no borra en cascada su deal correspondiente. Suficiente para que el cliente vea sus leads reflejados en el CRM, pero no es una relación de base de datos real todavía.
