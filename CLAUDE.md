...
2. ✅ **Strategist AI v3.0 (Tendencias)** — define estrategia + trend finder (NewsAPI/Google News RSS). ID: `S62o0wcXq8Wfj67S`. Archivo: `workflow-strategist-ai-g54-v3.json`
3. ✅ **Distribution AI v1.0** — publica FB/IG via Graph API directo. ID: `nmOjyvdfTkEo5FVJ`. Archivo: `workflow-distribution-ai-g54.json`
4. ✅ **Community AI v1.0** — responde comentarios y DMs de FB/IG. ID: `62tIvF0snsrMj0sM`. Archivo: `workflow-community-ai-g54.json`
